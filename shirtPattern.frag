...
void main() {
    ...
    float diamondTL = dot(abs(st-vec2(0.,1.)), vec2(1.0, 0.4+abs(tan(u_time))*0.5));
    float diamondTR = dot(abs(st-vec2(1.,1.)), vec2(1.0, 0.4+abs(tan(u_time))*0.5));
    float diamondBR = dot(abs(st-vec2(1.,0.)), vec2(1.0, 0.4+abs(tan(u_time))*0.5));
    float diamondBL = dot(abs(st-vec2(0.,0.)), vec2(1.0, 0.4+abs(tan(u_time))*0.5));
